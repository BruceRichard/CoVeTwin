...
parser.add_argument("--output_dir", type=str, default="im_data_obj_sort_new_32_finetune_v2codec_cot")
...
with open(os.path.join(args.output_dir,'training_set_'+str(args.ind)+'_randompart_v2codec_cot.json'), 'w') as json_file:
