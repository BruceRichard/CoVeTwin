...
parser = argparse.ArgumentParser(description="Render URDF evaluation results to MP4 videos")
parser.add_argument(
    "--evalpath",
    default="test_demo",
    help="Directory containing per-object folders with basic.urdf",
)
parser.add_argument(
    "--savepath",
    default="evaluation_video_physxanything",
    help="Directory in which rendered MP4 files are saved",
)
