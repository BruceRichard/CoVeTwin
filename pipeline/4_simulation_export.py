#!/usr/bin/env python3
"""Stage 4: export physical metadata, URDF, and MuJoCo XML assets."""
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="Export CoVeTwin predictions as URDF and MuJoCo XML assets."
    )
    parser.add_argument('--voxel_define', type=int, default=32, help='Resolution of the voxel.')
    parser.add_argument('--basepath', type=str, default='./test_demo', help='Prediction root.')
    parser.add_argument('--process', type=int, default=0, help='Enable postprocessing.')
    parser.add_argument('--fixed_base', type=int, default=0, help='Fix the base body in MJCF.')
    parser.add_argument('--deformable', type=int, default=0, help='Enable deformable MJCF parts.')
    ...
    for filename in namelist:
        ...
        if os.path.exists(os.path.join(basepath,filename,'objs')):
            ...
            shutil.copy(
                PROJECT_ROOT / "assets" / "simulation" / "desert.png",
